encdec_results/finnish-test.low.sys:
	...
	python2.7 ./evaluation/evalm.py --guess encdec_results/finnish-test.low.sys --gold encdec_results/finnish-500-dev --task 1
	python2.7 ./evaluation/evalm.py --guess encdec_results/finnish-test.low.sys.weighted-votes-basic --gold encdec_results/finnish-500-dev --task 1
	python2.7 ./evaluation/evalm.py --guess encdec_results/finnish-test.low.sys.weighted-votes --gold encdec_results/finnish-500-dev --task 1